(window["canvasWebpackJsonp"]=window["canvasWebpackJsonp"]||[]).push([[369,602],{"/UXv":function(e,t,n){"use strict"
n.d(t,"a",function(){return i})
var r=n("QF4Q")
var a=n("pgSO")
function i(e){var t=e&&Object(r["a"])(e)
return t&&Object(a["a"])()===t}},"0crz":function(e,t,n){"use strict"
var r=n("ouhR")
var a=n.n(r)
var i=n("pQTu")
var s=n("m0r6")
...
n=Math.floor(n/1e3)
a=r+a}return i+String(n)+a},truncateText:function(e,t){var n,r,a,i,s,l
null==t&&(t={})
r=null!=(i=t.max)?i:30
n=o.t("ellipsis","...")
...
s=0
while(true){a=e.indexOf(l,s+1)
if(a<0||a>r-n.length)break
s=a}s||(s=r-n.length)
return e.substring(0,s)+n},plainText:function(e){return e.replace(/(<([^>]+)>)/gi,"")}}},"3zPy":function(e,t){function n(e){if(e&&"object"===typeof e){var t=e.which||e.keyCode||e.charCode
...
if("string"===typeof t){var i=r[t.toLowerCase()]
if(i)return i===n
i=a[t.toLowerCase()]
if(i)return i===n}else if("number"===typeof t)return t===n
return false}}
t=e.exports=n
var r=t.code=t.codes={backspace:8,tab:9,enter:13,shift:16,ctrl:17,alt:18,"pause/break":19,"caps lock":20,esc:27,space:32,"page up":33,"page down":34,end:35,home:36,left:37,up:38,right:39,down:40,insert:45,delete:46,command:91,"left command":91,"right command":93,"numpad *":106,"numpad +":107,"numpad -":109,"numpad .":110,"numpad /":111,"num lock":144,"scroll lock":145,"my computer":182,"my calculator":183,";":186,"=":187,",":188,"-":189,".":190,"/":191,"`":192,"[":219,"\\":220,"]":221,"'":222}
...
for(i in r)s[r[i]]=i
for(var o in a)r[o]=a[o]},"4Awi":function(e,t,n){"use strict"
function r(e){return"string"===typeof e?e:e.displayName||e.name}n.d(t,"a",function(){return a})
function a(e){var t=arguments.length>1&&void 0!==arguments[1]?arguments[1]:[]
if(e&&e.type){var n=t.map(function(e){return r(e)})
return n.indexOf(r(e.type))>=0}return false}},"6SzX":function(e,t,n){"use strict"
...
var h=n("jtGx")
var m,b,v,x,w
var y={componentId:"ergWt",template:function(e){return"\n\n.ergWt_bGBk{border:0;clip:rect(0 0 0 0);height:0.0625rem;inset-inline-start:0;margin:-0.0625rem;overflow:hidden;padding:0;position:absolute;top:0;width:0.0625rem}\n\n[dir=ltr] .ergWt_bGBk{left:0}\n\n[dir=rtl] .ergWt_bGBk{right:0}"},root:"ergWt_bGBk"}
var k=(m=Object(p["a"])(),b=Object(f["i"])(null,y),m(v=b(v=(w=x=function(e){Object(l["a"])(t,e)
function t(){Object(a["a"])(this,t)
return Object(s["a"])(this,Object(o["a"])(t).apply(this,arguments))}Object(i["a"])(t,[{key:"render",value:function(){var e=this.props,n=e.children,a=Object(r["a"])(e,["children"])
var i=Object(g["a"])(t,a)
return c.a.createElement(i,Object.assign({},Object(h["b"])(a),{className:y.root}),n)}}])
t.displayName="ScreenReaderContent"
return t}(u["Component"]),x.propTypes={as:_.a.elementType,children:_.a.node},x.defaultProps={as:"span",children:null},w))||v)||v)},B1vq:function(e,t,n){"use strict"
var r=n("ouhR")
var a=n.n(r)
n("s/PJ")
...
var r=n.offset(),i=n.outerWidth(),s=n.outerHeight(),o=r.top,l=o+s,u=r.left,c=u+i,d="html,body"==this.selector?a.a.windowScrollTop():this.scrollTop(),_=this.scrollLeft(),f=this.outerHeight(),p=this.outerWidth()
...
l-=g.top
u-=g.left
c-=g.left}if("HTML"==this[0].tagName||"BODY"==this[0].tagName){f=a()(window).height()
a()("#wizard_box:visible").length>0&&(f-=a()("#wizard_box:visible").height())
p=a()(window).width()
o-=d
u-=_
l-=d
c-=_}o<0||f<s&&l>f?t.scrollTop=o+d:l>f&&(t.scrollTop=l+d-f+20)
u<0?t.scrollLeft=u+_:c>p&&(t.scrollLeft=c+_-p+20)
1==t.scrollTop&&(t.scrollTop=0)
1==t.scrollLeft&&(t.scrollLeft=0)
this.scrollTop(t.scrollTop)
this.scrollLeft(t.scrollLeft)
return this}},ZELe:function(e,t,n){"use strict"
n.d(t,"a",function(){return r})
function r(e){return function(t,n,r){var a=t[n]
...
return e.apply(void 0,[t,n,r].concat(s))}}},dpqJ:function(e,t,n){"use strict"
n.d(t,"a",function(){return s})
var r=n("q1tI")
var a=n.n(r)
var i=n("ZELe")
var s={oneOf:function(e){function t(t,n,r){var i=a.a.Children.toArray(t[n])
var s=e.map(function(e){return e?o(e):e})
for(var l=0;l<i.length;l++){var u=i[l]
if(u&&u.type){var c=o(u.type)
if(s.indexOf(c)<0)return new Error("Expected one of ".concat(s.join(", ")," in ").concat(r," but found '").concat(c,"'"))}else if(u)return new Error("Expected one of ".concat(s.join(", ")," in ").concat(r," but found an element with unknown type: ").concat(u))}}t.isRequired=Object(i["a"])(t)
return t},oneOfEach:function(e){return function(t,n,r){var i=a.a.Children.toArray(t[n])
var s={}
var l=e.map(function(e){var t=o(e)
s[t]=0
return t})
for(var u=0;u<i.length;u++){var c=i[u]
if(c&&c.type){var d=o(c.type)
if(l.indexOf(d)<0)return new Error("Expected one of ".concat(l.join(", ")," in ").concat(r," but found '").concat(d,"'"))
s[d]=(s[d]||0)+1}else if(c)return new Error("Expected one of ".concat(l.join(", ")," in ").concat(r," but found an element of unknown type: ").concat(c))}var _=[]
Object.keys(s).forEach(function(e){s[e]>1&&_.push("".concat(s[e]," children of type ").concat(e))
0===s[e]&&_.push("0 children of type ".concat(e))})
if(_.length>0)return new Error("Expected exactly one of each ".concat(l.join(", ")," in ").concat(r," but found:\n  ").concat(_.join("\n")))}},enforceOrder:function(){for(var e=arguments.length,t=new Array(e),n=0;n<e;n++)t[n]=arguments[n]
function r(e,t){for(var n=0;n<e.length;n++)if(e[n]!==t[n])return false
return true}function s(e,t){return t.map(function(t){return l(e,t)}).join("\n\n")}function l(e,t){var n=t.map(function(e){return e?o(e):"??"}).map(function(e){return"  <".concat(e," />")}).join("\n")
return"<".concat(e,">\n").concat(n,"\n</").concat(e,">")}function u(e,n,i){var u=a.a.Children.toArray(e[n]).map(function(e){if(e&&e.type)return o(e.type)
if(e)return null})
for(var c=0;c<t.length;c++){var d=t[c].map(function(e){return e?o(e):"??"})
if(r(u,d))return}return new Error("Expected children of ".concat(i," in one of the following formats:\n  ").concat(s(i,t),"\n\n\n  Instead of:\n  ").concat(l(i,u)))}u.isRequired=Object(i["a"])(u)
return u}}
var o=function(e){return"string"===typeof e?e:e.displayName||e.name}},"i+HM":function(e,t,n){"use strict"
var r=n("An8g")
var a=n("VTBJ")
var i=n("q1tI")
var s=n.n(i)
...
var o=n("5Shj")
var l=n("EcmN")
function u(e){return s.a.createElement("a",Object.assign({rel:"noopener noreferrer",target:"_blank"},e),l["a"].t("SpeedGrader™"))}function c(e){const t=e.className?"icon-speed-grader ".concat(e.className):"icon-speed-grader"
...
return e.disabled?Object(r["a"])(o["a"],{placement:"bottom",tip:e.disabledTip,variant:"inverse"},void 0,u(n)):u(n)}t["a"]=c},"m+tm":function(e,t,n){"use strict"
n.r(t)
var r=n("ouhR")
var a=n.n(r)
n("/j35")
...
this.onStudentGroupSelected=this.onStudentGroupSelected.bind(this)}onStudentGroupSelected(e){if("0"!==e){s["a"].put("/api/v1/courses/".concat(this.props.courseId,"/gradebook_settings"),{gradebook_settings:{filter_rows_by:{student_group_id:e}}})
...
var i=n("EcmN")
n("q1tI")
function s(e){return Object(r["a"])("option",{value:e.id},e.id,e.name)}function o(e){return Object(r["a"])("optgroup",{label:e.name},"group_category_".concat(e.id),e.groups.map(e=>s(e)))}function l(e){return Object(r["a"])(a["a"],{id:"student-group-filter",label:e.label},void 0,Object(r["a"])("select",{onChange:t=>{e.onChange(t.target.value)},style:{margin:"0",width:"100%"},value:e.value||"0"},void 0,Object(r["a"])("option",{"aria-disabled":"true",disabled:"disabled",value:"0"},"0",i["a"].t("Select One")),e.categories.map(e=>o(e))))}t["a"]=l},p6Wi:function(e,t,n){"use strict"
var r=n("pQTu")
var a=n("m0r6")
...
a.authenticity_token=Object(u["a"])()
o.a.ajaxJSON(e.url,"DELETE",a,n=>{e.success.call(t,n)},(n,r,a,i)=>{e.error&&o.a.isFunction(e.error)?e.error.call(t,n,r,a,i):o.a.ajaxJSON.unhandledXHRs.push(r)})}else{e.success||(e.success=function(){t.fadeOut("slow",()=>{t.remove()})})
e.success.call(t)}}
if(e.message&&!e.noMessage&&!o.a.skipConfirmations){if(e.dialog){r=false
var s="object"==typeof e.dialog?e.dialog:{}
n=o()(e.message).dialog(o.a.extend({},{modal:true,close:a,buttons:[{text:i.t("#buttons.cancel","Cancel"),click:function(){o()(this).dialog("close")}},{text:i.t("#buttons.delete","Delete"),class:"btn-primary",click:function(){r=true
o()(this).dialog("close")}}]},s))
return}r=confirm(e.message)}a()}
o.a.fn.confirmDelete.defaults={get message(){return i.t("confirms.default_delete_thing","Are you sure you want to delete this?")}}
...
l.doc[0]==i[0]&&(s=true)}s||o.a._checkFragments.fragmentList.push({doc:i,fragment:""})
...
return this}
o.a.fn.fillWindowWithMe=function(e){var t=o.a.extend({minHeight:400},e),n=o()(this),r=o()("#wrapper"),a=o()("#main"),i=o()("#not_right_side"),s=o()(window),l=o()(this).add(t.alsoResize)
function u(){l.height(0)
var e=s.height()-(r.offset().top+r.outerHeight())+(a.height()-i.height()),u=Math.max(400,e)
l.height(u)
...
this.filter("input:text").each(function(){var t=e.minWidth||o()(this).width(),n="",r=o()(this),a=o()("<tester/>").css({position:"absolute",top:-9999,left:-9999,width:"auto",fontSize:r.css("fontSize"),fontFamily:r.css("fontFamily"),fontWeight:r.css("fontWeight"),letterSpacing:r.css("letterSpacing"),whiteSpace:"nowrap"}),i=function(){setTimeout(()=>{if(n===(n=r.val()))return
a.text(n)
var i=a.width(),s=i+e.comfortZone>=t?i+e.comfortZone:t,o=r.width(),l=s<o&&s>=t||s>t&&s<e.maxWidth
l&&r.width(s)})}
a.insertAfter(r)
o()(this).bind("keyup keydown blur update change",i)})
return this}
o.a},pgSO:function(e,t,n){"use strict"
n.d(t,"a",function(){return r})
function r(e){try{return(e||document).activeElement}catch(e){}}},ppAs:function(e,t,n){"use strict"
var r=n("ouhR")
var a=n.n(r)
var i=n("GLiE")
var s=n.n(i)
...
n.html(t)
return n},toMediaCommentLink(e){const t=a()("<a\n        id='media_comment_".concat(Object(o["a"])(a()(e).data("media_comment_id")),"'\n        data-media_comment_type='").concat(Object(o["a"])(a()(e).data("media_comment_type")),"'\n        class='instructure_inline_media_comment ").concat(Object(o["a"])(e.nodeName.toLowerCase()),"_comment'\n        data-alt='").concat(Object(o["a"])(a()(e).attr("data-alt")),"'\n      />"))
t.html(a()(e).html())
...
t["a"]=d},"z4M/":function(e,t,n){"use strict"
...
a.a.Children.forEach(e,function(e){e&&!Object(i["a"])(e,[s["a"]])&&(t=true)})
return t}}}])

//# sourceMappingURL=module_sequence_footer-c-11ecbe9fec.js.map